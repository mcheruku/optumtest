...
GO
CREATE NONCLUSTERED INDEX [NC_CustomerSubscription_CustomerID] ON [tescosubscription].[CustomerSubscription] ([CustomerID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NC_CustomerSubscription_NextPaymentDate] ON [tescosubscription].[CustomerSubscription] ([NextPaymentDate]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NC_CustomerSubscription_PaymentProcessStatus] ON [tescosubscription].[CustomerSubscription] ([PaymentProcessStatus]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NC_CustomerSubscription_SubscriptionStatus_NextRenewalDate] ON [tescosubscription].[CustomerSubscription] ([SubscriptionStatus], [NextRenewalDate]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
