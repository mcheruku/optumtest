...
GO
CREATE CLUSTERED INDEX [CI_CustomerSubscriptionSwitchHistory_CustomerSubscriptionID] ON [tescosubscription].[CustomerSubscriptionSwitchHistory] ([CustomerSubscriptionID]) ON [PRIMARY]
GO
