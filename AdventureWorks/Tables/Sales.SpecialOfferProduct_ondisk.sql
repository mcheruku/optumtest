...
GO
ALTER TABLE [Sales].[SpecialOfferProduct_ondisk] ADD CONSTRAINT [ODPK_SpecialOfferProduct_SpecialOfferID_ProductID] PRIMARY KEY NONCLUSTERED  ([SpecialOfferID], [ProductID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [ix_ProductID] ON [Sales].[SpecialOfferProduct_ondisk] ([ProductID]) ON [PRIMARY]
GO
