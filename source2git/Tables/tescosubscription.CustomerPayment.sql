...
GO
CREATE NONCLUSTERED INDEX [NC_CustomerPayment_CustomerID] ON [tescosubscription].[CustomerPayment] ([CustomerID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NC_CustomerPayment_PaymentToken] ON [tescosubscription].[CustomerPayment] ([PaymentToken]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
