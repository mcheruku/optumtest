...
GO
CREATE NONCLUSTERED INDEX [NC_CustomerPaymentHistory_CustomerSubscriptionID] ON [tescosubscription].[CustomerPaymentHistory] ([CustomerSubscriptionID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NC_CustomerPaymentHistory_IsEmailSent] ON [tescosubscription].[CustomerPaymentHistory] ([IsEmailSent]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NC_CustomerPaymentHistory_PackageExecutionHistoryID] ON [tescosubscription].[CustomerPaymentHistory] ([PackageExecutionHistoryID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
